...
namespace DTOs.ACAD.ACAD_Course.Responses
{
    public class CourseDetailResponse : CourseResponse
    {
        ...
        public List<CourseFeedbackListResponse> CourseFeedbacks { get; set; } = new List<CourseFeedbackListResponse>();
        public List<CourseScheduleInfo> WeeklySchedule { get; set; } = new List<CourseScheduleInfo>();
    }
