...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251130160025_AddPaymentAndEnrollmentToAcademicRequest")]
    partial class AddPaymentAndEnrollmentToAcademicRequest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.ACAD_AcademicRequest", b =>
                {
                    ...
                    b.Property<bool?>("CompletedExitSurvey")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("ExitSurveyId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Entities.ACAD_ClassReservation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("ClassReservationID");
            ...
            modelBuilder.Entity("Domain.Entities.ACAD_CourseWishlist", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.ACAD_Enrollment", b =>
                {
                    ...
                    b.Property<int>("EmailDecisionStatus")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.ACAD_PlacementQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("PlacementQuestionID");
                    ...
                    b.ToTable("ACAD_PlacementQuestions");
                });

            modelBuilder.Entity("Domain.Entities.ACAD_PlacementTest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("PlacementTestID");
            ...
            modelBuilder.Entity("Domain.Entities.ACAD_WeeklyFeedback", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("AssignmentQuality")
                        .IsRequired()
                        .HasMaxLength(2000)
                    ...
                    b.HasIndex("ClassID", "StudentID", "WeekNumber")
                        .IsUnique();

                    b.ToTable("ACAD_WeeklyFeedback", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.HR_TeacherAvailability", b =>
                {
                    ...
                    b.HasIndex("TeacherID", "TeachDay", "TimeSlotID")
                        .IsUnique()
            ...
            modelBuilder.Entity("Domain.Entities.IDN_Student", b =>
                {
                    ...
                    b.Property<decimal?>("PlacementTestGrade")
                        .HasPrecision(5, 2)
                        .HasColumnType("decimal(5,2)");
            ...
            modelBuilder.Entity("Domain.Entities.ACAD_AcademicRequest", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.ACAD_Enrollment", "Enrollment")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.ACAD_ClassReservation", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.CORE_LookUp", "ReservationStatus")
                        .WithMany("ACAD_ClassReservations")
            ...
            modelBuilder.Entity("Domain.Entities.ACAD_PlacementQuestion", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.CORE_LookUp", "QuestionType")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.ACAD_Class", b =>
                {
                    ...
                    b.Navigation("ACAD_WeeklyFeedbacks");
                });
            ...
            modelBuilder.Entity("Domain.Entities.ACAD_Course", b =>
                {
                    ...
                    b.Navigation("ACAD_CourseWishlists");
